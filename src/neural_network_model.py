...
confusion_matrix_image_path = os.path.join(output_dir, 'neural_network_model_confusion_matrix.png')
...
learning_curve_image_path = os.path.join(output_dir, 'neural_network_model_learning_curve.png')
